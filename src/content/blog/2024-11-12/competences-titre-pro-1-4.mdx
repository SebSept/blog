...
draft: false
tags: ["Symfony", "apiplatform", "docker", "projet"]
slug: "competences-titre-pro-1-4"
...
import Callout from '/src/components/Callout/Callout.astro'
  ...
  <Callout>
J'ai obtenu mon Titre Professionnel de Développeur Concepteur d'application (Bachelor, niveau 6, bac +3). À l'occasion de ce titre, j'ai présenté mon dossier de projet devant un jury de professionnels. C'est un bel élément pour faire une démonstration de mes compétences, j'en profite donc pour vous faire aussi cette démonstration.

Pour réaliser ce projet, j'ai traité l'ensemble des compétences du [référentiel de certification](https://www.francecompetences.fr/recherche/rncp/6255/).
...
Pour les curieux qui ont du temps ➡ [mon dossier de projet professionnel](http://dev.seb7.fr/dossier_de_projet.pdf).

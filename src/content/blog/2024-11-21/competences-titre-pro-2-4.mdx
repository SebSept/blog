...
Ce post est le second d'une série de quatre articles qui décrivent mon dossier de projet professionnel. Le premier post se trouve [ici](/posts/dossier-de-projet).
